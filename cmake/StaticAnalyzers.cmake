...
option(MO_ENABLE_CLANG_TIDY "Run clang-tidy alongside the compiler" ON)
option(MO_ENABLE_CPPCHECK "Run cppcheck alongside the compiler" OFF)
option(MO_ENABLE_IWYU "Run include-what-you-use alongside the compiler" OFF)
...
function(enable_static_analyzers target_name)
    if(MO_ENABLE_CLANG_TIDY AND NOT CMAKE_CXX_CLANG_TIDY)
    ...
    if(MO_ENABLE_CPPCHECK AND NOT CMAKE_CXX_CPPCHECK)
    ...
    if(MO_ENABLE_IWYU AND NOT CMAKE_CXX_INCLUDE_WHAT_YOU_USE)
