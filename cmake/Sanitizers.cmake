...
# Sanitizer selection. Set MO_ENABLE_SANITIZER to one of:
...
set(MO_ENABLE_SANITIZER "" CACHE STRING
    "Enable a sanitizer (one of: asan, tsan, ubsan, msan, lsan)")

function(enable_sanitizers target_name)
    if(NOT MO_ENABLE_SANITIZER)
        return()
    endif()
    ...
    if(MO_ENABLE_SANITIZER STREQUAL "asan")
    ...
    elseif(MO_ENABLE_SANITIZER STREQUAL "tsan")
    ...
    elseif(MO_ENABLE_SANITIZER STREQUAL "lsan")
        # LeakSanitizer.
        set(SANITIZER_FLAGS -fsanitize=leak)
        message(STATUS "Enabling LeakSanitizer")
    else()
        message(FATAL_ERROR
            "Unknown sanitizer '${MO_ENABLE_SANITIZER}' "
